...
async def get_manifest_json():
    return {
        ...
        "description": "Nimarungi is an open, extensible, user-friendly AI assitant with all your best models.",
        "start_url": "/",
        "display": "standalone",
...
async def get_opensearch_xml():
    ...
    <ShortName>{Nimarungi}</ShortName>
    <Description>Search {Nimarungi}</Description>
